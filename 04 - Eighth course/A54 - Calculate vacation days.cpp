...
short CalcVacationDays(stDate DateFrom, stDate DateTo)
{
...
int main()
{
	...
	cout << "\nVacation from : " << GetDayName(GetDayIndex(DateFrom)) << " , " << DateFrom.Day << "/" << DateFrom.Month << "/" << DateFrom.Year;
	cout << "\nVacation to   : " << GetDayName(GetDayIndex(DateTo)) << " , " << DateTo.Day << "/" << DateTo.Month << "/" << DateTo.Year << endl;


	cout << "\n\nActual vacation days is : " << CalcVacationDays(DateFrom, DateTo) << endl;
}
